...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a><a href="javascript:;" onclick="category_add()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th scope="col" colspan="14">管理员列表</th>
			</tr>
			<tr class="text-c">
...
function category_add(){
	...
	//第三个参数：窗口的宽度
	//第四个参数；窗口的高度
	layer_show('添加分类','{{url("yb-admin/adminadd")}}',1000);
}
