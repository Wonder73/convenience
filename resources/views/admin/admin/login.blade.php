...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="{{url('yb-admin/loginok')}}" method="post">{{csrf_field()}}
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input class="input-text size-L" name="captcha" type="text" placeholder=""  value="" style="width:150px;">
          <img src="{{captcha_src()}}" onclick ='this.src="{{captcha_src()}}"+Math.random()'/><br/> 
        <div>{{$errors->first('captcha')}}</div></div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
